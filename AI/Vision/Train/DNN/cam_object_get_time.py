...
file1 = open("tempo.csv","w") 
file1.write("#Rede 0.25_128\n") 
...
#      print("Final do processo", time() - start_time)
      start_time = time()
...
#      plt.imshow(image_np)
      ...
      file1.write(str(seconds_elapsed)+"\n") 
...
#      fps.update()
      if(time() - start_time_process > 600):
          print "Finalizando processo com tempo de ", time() - start_time_process, "segundos"
          file1.writelines("#Finalizando processo com tempo de "+ str(time() - start_time_process)+ "segundos")
